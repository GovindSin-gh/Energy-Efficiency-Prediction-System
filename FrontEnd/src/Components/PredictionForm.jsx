...
export default function PredictionForm({ onSubmit, loading }) {
  ...
  const inputFields = [
    { name: 'Relative_Compactness', label: 'Relative Compactness', min: 0.5, max: 1.0, step: 'any' },
    { name: 'Surface_Area', label: 'Surface Area', min: 400, max: 900, step: 'any' },
    { name: 'Wall_Area', label: 'Wall Area', min: 200, max: 500, step: 'any' },
    { name: 'Roof_Area', label: 'Roof Area', min: 100, max: 300, step: 'any' },
    { name: 'Overall_Height', label: 'Overall Height', min: 3, max: 10, step: 'any' },
    { name: 'Orientation', label: 'Orientation', min: 1, max: 4, step: 'any' },
    { name: 'Glazing_Area', label: 'Glazing Area', min: 0, max: 0.4, step: 'any' },
    { name: 'Glazing_Area_Distribution', label: 'Glazing Area Distribution', min: 0, max: 5, step: 'any' }
  ];
